...
#include <iostream>
using namespace std;
void mailage(int destination , int petrolprice , int diselprice, int petrolkilometer, int dieselkilometer){
    if (petrolprice*petrolkilometer > dieselkilometer * diselprice){
        cout<<"Petrol"<<endl;
    }
    else if(petrolprice*petrolkilometer < dieselkilometer * diselprice){
        cout<<"Disel"<<endl;
    }else if(petrolprice*petrolkilometer == dieselkilometer * diselprice){
        cout<<"Any"<<endl;
    }
